            ...
            <div className="slider-card-wrapper">
              <div className="slider-card">
                <div className="slider-card-wrapper-upper">
                  <img
                    alt="caretaking-icon"
                    className="image-clean-forswipe"
                    src={caretakingsimple}
                  />
                </div>
                <div className="slider-card-wrapper-bottom">
                  <div className="slider-card-wrapper-bottom-upper">
                    <div className="slider-card-wrapper-bottom-upper-title">
                      ...
                      <div className="slider-card-wrapper-bottom-upper-location">
                        <span>
                          <img
                            alt="location-icon"
                        ...
                        <h5 className="location-wa">Seattle, WA</h5>
                      </div>
                    </div>
                    <div>
                ...
                <div className="slider-card-wrapper-bottom-bottom">
                  <div className="hourly-rate">
                    <h3 className="slider-card-wrapper-compensation">$45</h3>
                    <span className="per-hour">/Hour</span>
                  </div>
                  <div>
                    <span>
                      <img
                        alt="saved-icon-unfilled"
            ...
            <div className="slider-card">
              ...
              <div className="slider-card-wrapper-bottom">
                <div className="slider-card-wrapper-bottom-upper">
                  <div className="slider-card-wrapper-bottom-upper-title">
                    <div>
                      <h4 className="position-title">Construction Manager</h4>
                    </div>
                    <div className="slider-card-wrapper-bottom-upper-location">
                      <span>
                        <img
                      ...
                      <h5 className="location-wa">Tacoma, WA</h5>
                    </div>
                  </div>
                  <div>
                    <h5 className="company-title">Barry's Builders</h5>
                  </div>
                </div>
              </div>
              <div className="slider-card-wrapper-bottom-bottom">
                <div className="hourly-rate">
                  <h3 className="compensation">$45</h3>
                  <span className="per-hour">/Hour</span>
                </div>
                <div>
                  <span>
            ...
            <div className="slider-card">
              ...
              <div className="slider-card-wrapper-bottom">
                <div className="slider-card-wrapper-bottom-upper">
                  <div className="slider-card-wrapper-bottom-upper-title">
                    <div>
                      <h4 className="position-title">Housekeeper</h4>
                    </div>
                    <div className="slider-card-wrapper-bottom-upper-location">
                      <span>
                        <img
                          alt="location-slider-icon"
                          className="location-img-slider"
                          src={locationImg}
                        />
                      </span>
                      <h5 className="location-wa">Renton, WA</h5>
                    </div>
                  </div>
                  <div>
                    <h5 className="company-title">Tidy Homes</h5>
                  </div>
                </div>
              </div>
              <div className="slider-card-wrapper-bottom-bottom">
